...
const PostCard = ({ post }) => {
  return (
    <div className='bg-white shadow-lg rounded-lg p-0 lg:p-8 pb-6 lg:pb-12 mb-8'>
      <h1 className='transition duration-700 pt-4 text-center mb-8 cursor-pointer hover:text-indigo-700 text-2xl lg:text-3xl font-semibold'>
      ...
      <div className='block lg:flex text-center items-center justify-center mb-8 w-full'>
        <div className='flex items-center justify-center mb-4 lg:mb-0 w-full lg:w-auto mr-8'>
          ...
          />
          <p className='inline align-middle text-gray-700 ml-1 lg:ml-2 text-lg'>
            {post.author.name}
          </p>
        </div>
        <div className='font-medium text-gray-700'>
          <svg
            ...
            className='h-5 w-5 lg:w-6 lg:h-6 inline mr-2 text-pink-500'
            fill='none'
            viewBox='0 0 24 24'
            stroke='currentColor'
          >
